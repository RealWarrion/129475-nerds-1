...
* Студент: [Егор(Warrion) Поликарпов](https://up.htmlacademy.ru/htmlcss/14/user/129475).
* Наставник: Второе прохождение `Без наставника`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/129475-nerds) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
